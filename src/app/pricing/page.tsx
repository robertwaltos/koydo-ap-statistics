...
export const metadata: Metadata = {
  title: "Pricing — Ap Statistics Premium",
  description: "Unlock unlimited Ap Statistics practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-statistics&cadence=annual`;
