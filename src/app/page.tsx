...
export const metadata: Metadata = {
  title: "Koydo AP Statistics — Free Exam Prep",
  description: "Comprehensive AP Statistics preparation. Practice tests, AI tutor, score tracking. This app is an independent study aid and is not affiliated with, endorsed by, or approved by AP or any official testing authority. All trademarks belong to their respective owners.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for AP Statistics?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real AP Statistics format." },
