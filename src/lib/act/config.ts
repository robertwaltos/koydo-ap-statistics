// Auto-generated shim — re-exports from @/lib/ap-statistics/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ap_statistics_Config } from "@/lib/ap-statistics/config";
import { EXAM_CONFIG as _raw } from "@/lib/ap-statistics/config";
